...
namespace OptionPricerWBook
{
    public class standAloneVol
    {
        ...
        public void standAlone_vol(int row_start, int row_count, int col_up)
        {
            ...
            Globals.Sheet4.Cells[row_start + 22, 6].Value = sum_;
            Globals.Sheet4.Cells[row_start + 23, 6].Value = _sum_;
        }
