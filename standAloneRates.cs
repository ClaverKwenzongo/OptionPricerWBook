...
namespace OptionPricerWBook
{
    public class standAloneRates
    {
        ...
        public void standAlone_rate(int row_start, int row_count, int col_up)
        {
            ...
            Globals.Sheet4.Cells[row_start + 22, 7].Value = sum_;
            Globals.Sheet4.Cells[row_start + 23, 7].Value = _sum_;
        }
