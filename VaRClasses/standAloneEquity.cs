...
namespace OptionPricerWBook
{
    public class standAloneEquity
    {
        ...
        public void standAlone_equity(int row_start, int row_count, int col_up)
        {
            ...
            while (string.IsNullOrWhiteSpace(Globals.Sheet4.Cells[row_start + 2, col_j].Value?.ToString()) == false)
            {
                ...
                else
                {
                    ...
                    sensitivity = double.Parse(Globals.Sheet4.Cells[row_start + 12, col_j].Value.ToString());
                ...
                while (date_r < row_count + 1)
                {
                    ...
                    if (string.IsNullOrWhiteSpace(Globals.Sheet1.Cells[date_r + 1, 2].Value?.ToString()) == false)
                    {
                        ...
                        double price_1 = pricer_1.optionPrice(spot_1, rf, vol, q);
                        double price_2 = pricer_2.optionPrice(spot_2, rf, vol, q);
            ...
            Globals.Sheet4.Cells[row_start + 22, 5].Value = sum_;
            Globals.Sheet4.Cells[row_start + 23, 5].Value = _sum_;
        }
